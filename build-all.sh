...
if [ -z "$*" ]
then
  MVN_ARGS="-Pscala-2.12.x -Peclipse-2021-12 $ADDITIONAL_MVN_OPTS clean install"
  MVN_P2_ARGS="-Dtycho.localArtifacts=ignore -Pscala-2.12.x -Peclipse-2021-12 $ADDITIONAL_MVN_OPTS clean verify"
else
  MVN_ARGS="$*"
